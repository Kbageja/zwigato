...
import wrap1 from "/src/store/wrap1.png"
import wrap5 from "/src/store/wrap5.png"
import wrap2 from "/src/store/wrap2.jpeg"
...
<div className="card cardmenu" style={{width: "18rem"}}>
  ...
  <div className='menubody'>
    ...
    <div className="foodgrid">
<div className="card cardmenu" style={{width: "18rem"}}>
  <img src={wrap2} className="card-img-top" alt="..."/>
  <div className="card-body card-bodymenu">
...
<div className="card cardmenu" style={{width: "18rem"}}>
  <img src={wrap1} className="card-img-top" alt="..."/>
  <div className="card-body card-bodymenu">
...
<div className="card cardmenu" style={{width: "18rem"}}>
  <img src={wrap5} className="card-img-top" alt="..."/>
  <div className="card-body card-bodymenu">
